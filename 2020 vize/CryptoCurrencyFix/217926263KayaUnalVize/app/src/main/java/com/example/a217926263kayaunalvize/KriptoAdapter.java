...
public class KriptoAdapter extends ArrayAdapter<KriptoPara> {
    ...
    public KriptoAdapter(Context context, int resource, List<KriptoPara> objects) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        symbolSatirKalibi.setText(kriptoPara.get_name() + " " + kriptoPara.get_symbol());
        priceSatirKalibi.setText("Fiyatı: " + kriptoPara.get_price());
        numberOfMarketsSatirKalibi.setText("İşlem görülen borsa sayısı: " + kriptoPara.get_numberOfMarkets());
        numberOfExchangesSatirKalibi.setText("takas edilebilir coin sayısı: " + kriptoPara.get_numberOfExchanges());
