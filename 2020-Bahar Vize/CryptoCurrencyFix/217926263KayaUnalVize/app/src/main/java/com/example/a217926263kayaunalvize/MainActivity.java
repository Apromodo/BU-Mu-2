...
public class MainActivity extends AppCompatActivity {
    ...
    //Bu Projede volley network kütüphanesi kullanılmıştır build gradle dosyasının içerisine
    //implementation 'com.android.volley:volley:1.1.1' (EKLENMEDEN ÇALIŞMAZ)
    //
    //
    // ilk açılıştı sorunsuz ancak dosyada değişiklik yapıp açtıgınızda uygulamayı kapatmanız gerekiyor (web api sorunu)
            ...
            public void onResponse(String response) {
                ...
                try {
                    ...
                    for(int i=0; i<data.length();i++){
                        ...
                        cyrptoList .add(new KriptoPara(symbol, name, price, String.valueOf(numberOfMarkets), String.valueOf(numberOfExchanges)));
